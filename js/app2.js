...
function montaTarefas(vDados,vComp, vUnidade){
    ...
    function(data){
        ...
        for(var i = 0; i<data.length;i++){
            ...
            $( "#"+vComp ).before("<div>");
            $( "#"+vComp ).before("<div><img src=\"img/"+vUnidade+".jpg\" width=\"60px\" class=\"img-circle\">");
